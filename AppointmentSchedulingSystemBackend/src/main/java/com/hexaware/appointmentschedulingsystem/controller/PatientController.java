...
//	}
	...
	Patient updatePatient(
			...
			@PathVariable("id") Long patient_id) throws Exception {
		Patient existingPatient =  patientService.findPatientById(patient_id)
				.orElseThrow(() -> new Exception("Patient not found with id" + patient_id));
		existingPatient.setUserId(patient.getUserId());
		existingPatient.setPatientName(patient.getPatientName());
		existingPatient.setPhoneNo(patient.getPhoneNo());
		
		return patientService.updatePatientById(existingPatient, patient_id);
	}
